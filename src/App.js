...
import CeramicCoating from './pages/CeramicCoating/CeramicCoating';
    ...
    <div className="App">
      <Router>
        ...
        <Routes>
          ...
          <Route path='/about-us' element={<LearnMore />} />
          ...
          <Route path='/services/ceramic-coating/ceramic-coating-packages' element={<CeramicCoating />} />
          ...
          <Route path='/services/detaling/fleet-detaling' element={<InteriorDetaling />} />
